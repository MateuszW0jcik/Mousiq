package org.example.orderservice.order.controller;
...
public class OrderController {
    ...
    public ResponseEntity<PageResponse<OrderSummaryDTO>> getUserOrders(
        ...
        return ResponseEntity.ok(orderService.getUserOrders(userId, page, size, sortBy, sortDir));
    }
    ...
    public ResponseEntity<OrderDTO> getUserOrderDetails(
        ...
        return ResponseEntity.ok(orderService.getUserOrderDetails(id, userId));
    }
    ...
    public ResponseEntity<OrderSummaryDTO> createOrder(
        ...
        OrderSummaryDTO orderSummaryDTO = orderService.createOrder(request, userId);
