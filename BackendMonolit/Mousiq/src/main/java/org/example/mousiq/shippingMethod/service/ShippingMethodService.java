package org.example.mousiq.shippingMethod.service;
...
import org.example.mousiq.shippingMethod.repository.ShippingMethodRepository;
...
public class ShippingMethodService {
    ...
    public ShippingMethodDTO addShippingMethod(ShippingMethodRequest request) {
        ...
        return new ShippingMethodDTO(shippingMethodRepository.save(shippingMethod));
    }
    @Transactional
